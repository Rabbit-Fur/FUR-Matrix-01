...
| GOOGLE_CALENDAR_ID | src/config.py, src/google_calendar_sync.py | Google Calendar ID used for sync |
...
| GOOGLE_CREDENTIALS_FILE | src/config.py, src/google_calendar_sync.py | OAuth token storage path |
...
| MONGODB_URI | src/config.py, src/mongo_service.py | MongoDB connection URI |
| MONGO_DB | src/config.py, src/mongo_service.py | MongoDB database name |
...
| REPO_GITHUB | utils/github_service.py, src/services/github_sync.py | Default GitHub repository |
...
| TOKEN_GITHUB_SYNC | src/services/github_sync.py | Token for sync service |
